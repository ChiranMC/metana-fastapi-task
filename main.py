...
async def root():
    try:
        ...
        return {"ReadMe message": "All the HTTP Methods : POST =  /usersdata/,  GET all users info: /usersdata/,  GET user info by emai: /userdata/user_email,  DELETE user: /deleteuser/",
